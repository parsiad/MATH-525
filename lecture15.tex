...
Then,
\begin{align*}
\mathbb{P}\left\{ \left|X_{1}+\cdots+X_{n}\right|\geq x\right\}  & =\mathbb{P}\left\{ \left|\frac{X_{1}+\cdots+X_{n}}{\sqrt{n}\sigma}\right|\geq\frac{x}{\sqrt{n}\sigma}\right\} \\
 & =\mathbb{P}\left\{ -\frac{x}{\sqrt{n}\sigma}\leq\frac{X_{1}+\cdots+X_{n}}{\sqrt{n}\sigma}\leq\frac{x}{\sqrt{n}\sigma}\right\} \\
 & =\cdots
\end{align*}
\end{xca}
...
where
\[
\sigma_{n}=\frac{1}{n}\sum_{j=1}^{n}\left(X_{j}-S_{n}\right)^{2}.
\]
