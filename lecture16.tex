...
\path [draw, thick, ->, >=stealth] (b.north east) -- node [above] {$1-p$} (c.north west);
\path [draw, thick, ->, >=stealth] (c.north east) -- node [above] {$1-p$} (d.north west);
\path [draw, thick, ->, >=stealth] (d.north east) -- node [above] {$1-p$} (e.north west);
\path [draw, thick, ->, >=stealth] (e.north east) -- node [above] {$1-p$} (f.north west);
\path [draw, thick, ->, >=stealth] (f.north east) -- node [above] {$1-p$} (g.north west);
\path [draw, thick, ->, >=stealth] (g.north east) -- node [above] {$1-p$} (h.north west);
\path [draw, thick, ->, >=stealth] (h.north east) -- node [above] {$1-p$} (i.north west);
\end{tikzpicture}
\end{figure}
